...
var runUpdate = function(instanceId, bucket, OutputFolder, callback) {
    var command = 'sudo yum update -y';
...
exports.update = function(event, kB, callback) {
    ...
    runUpdate(event.instanceID, event.bucket, event.OutputFolder, callback, function(response) {
